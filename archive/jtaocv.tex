...
~\begin{tabular}{lP{3.5cm}P{11cm}}
	...
	\newline
	Arizona State University                          \\
	2022/12--2022/12 & \textbf{Guest Professor}     &
...
\begin{tabular}{p{0.6\textwidth}p{0.4\textwidth}}
	...
	(Published, In Press, and/or Accepted)            & 38 \\
	Journal publications from ASU                     & 13 \\
	...
	(to be submitted before 06/31/2023)               & 5  \\
...
\begin{tabular}{p{0.6\textwidth}p{0.4\textwidth}}
	Editor, Associate Editor for peer-reviewed journals  & 1  \\
	International/national conference chaired            & 3  \\
...
\begin{longtable}{p{0.1\textwidth}p{0.6\textwidth}p{0.3\textwidth}}
	\DTLforeach{orgconfs}{
		...
		\location=Location}{%
	\\
	\year & \service\ \linebreak @\ \conference & \location
	}
\end{longtable}
...
\begin{itemize}
	...
	\item Co-Guest Editor for Special Issue on "Bio-inspired Geotechnics" by Acta Geotechnica
	\item Co-Editor for Special Issue on "Bio-inspired Burrowing Robots" by Frontiers In Robotics and AI
\end{itemize}
